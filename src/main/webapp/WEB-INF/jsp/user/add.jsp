					...
					<div class="panel-body">
						<form role="form">
							<div class="form-group">
								<label for="exampleInputPassword1">用户名</label> <input type="text" class="form-control" autofocus="autofocus" id="username" placeholder="请输入登陆账号">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">密码</label> <input type="text" class="form-control" id="password" placeholder="请输入登陆密码">
							</div>
							<div class="form-group">
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#insertButton").click(function () {
				...
				if ( username == ""){
					layer.msg("用户名不为空",{time:1000, icon:5, shift:6}, function() {
						//设置焦点
						$("#username").focus();
					})
					return ;
				...
				if ( password == ""){
					layer.msg("密码不为空",{time:1000, icon:5, shift:6}, function() {
						$("#password").focus();
					})
					return ;
				}
