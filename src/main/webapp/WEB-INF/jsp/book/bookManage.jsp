					...
					<ul style="padding-left: 0px;" class="list-group">
						...
						<li class="list-group-item"><span><i class="glyphicon glyphicon-ok"></i> 图书管理 <span class="badge" style="float: right">2</span></span>
							<ul style="margin-top: 10px;">
								<li style="height: 30px;"><a href="${APP_PATH}/book/bookManage" style="color: red;"><i class="glyphicon glyphicon-check"></i> 图书列表 </a></li>
				...
				success : function(result) {
					...
					if (result.success) {
						...
						for (var i = 0; i < datas.length; i++) {
							...
							context += '	<td>' + data.bookIssn + '</td>';
							context += '	<td>' + data.bookName + '</td>';
							context += '	<td>' + data.bookPress + '</td>';
							context += '	<td>' + data.bookAuthor + '</td>';
							context += '	<td>' + data.publicationDate + '</td>';
							context += '	<td>' + data.bookPrice + '</td>';
							context += '	<td>' + data.bookRepertory + '</td>';
							context += '	<td>';
